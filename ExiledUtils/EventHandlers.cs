...
namespace ExiledUtils
{
    public class EventHandlers
    {
        ...
        {
            if (Main.Singleton.Config.InfiniteAmmoConfig.InfiniteAmmoEnable)
            {
                ev.Shooter.Ammo.Add(ItemType.Ammo9x19, Main.Singleton.Config.InfiniteAmmoConfig.AmmoValues);
                ev.Shooter.Ammo.Add(ItemType.Ammo762x39, Main.Singleton.Config.InfiniteAmmoConfig.AmmoValues);
                ev.Shooter.Ammo.Add(ItemType.Ammo556x45, Main.Singleton.Config.InfiniteAmmoConfig.AmmoValues);
                ev.Shooter.Ammo.Add(ItemType.Ammo44cal, Main.Singleton.Config.InfiniteAmmoConfig.AmmoValues);
                ev.Shooter.Ammo.Add(ItemType.Ammo12gauge, Main.Singleton.Config.InfiniteAmmoConfig.AmmoValues);
            }
        }
