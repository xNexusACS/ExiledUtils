...
namespace ExiledUtils
{
    public class EventHandlers
    {
        ...
        {
            if (Main.Singleton.Config.InfiniteAmmoConfig.InfiniteAmmoEnable && ev.Shooter?.CurrentItem is Firearm firearm)
                firearm.Ammo++;
        }
        public void OnAddingTarget(AddingTargetEventArgs ev)
        {
            ev.Scp096.ShowHint(Main.Singleton.Config.AddingTargetConfig.Scp096Hint, Main.Singleton.Config.AddingTargetConfig.HintsDuration);
            ev.Target.ShowHint(Main.Singleton.Config.AddingTargetConfig.TargetHint, Main.Singleton.Config.AddingTargetConfig.HintsDuration);
        }
        public void OnUsingMicroEnergy(UsingMicroHIDEnergyEventArgs ev)
        {
            ev.IsAllowed = Main.Singleton.Config.MicroConfig.UnlimitedMicroHID;
        }
